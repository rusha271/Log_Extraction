            ...
            with open(output_file, "w", encoding="utf-8") as outfile:
                ...
                while True:
                    ...
                    for line in lines[:-1]:
                        ...
                        if filtered_line:
                            # If a filtered line is found, write it as-is to the output file
                            outfile.write(filtered_line)  # Write the filtered line and start a new line
                        else:
                            # If no filtered line is found, write the current line as-is to the output file
